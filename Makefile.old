# This Makefile is for the LendingClub extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/LendingClub.pm]
#     AUTHOR => q[Shane P Connelly <shane@eskibars.com>]
#     BUILD_REQUIRES => {  }
#     NAME => q[LendingClub]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/LendingClub.pm]
...
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/LendingClub.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/LendingClub.pm

PM_TO_BLIB = lib/LendingClub.pm \
	blib\lib\LendingClub.pm
...
DISTNAME = LendingClub
DISTVNAME = LendingClub-0.01
...
LendingClub.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"LendingClub\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/LendingClub.pm $(INST_MAN3DIR)\LendingClub.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               LendingClub" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            0.01" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           Perl extension for interacting with Lending Club" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - Shane P Connelly <shane@eskibars.com>" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl extension for interacting with Lending Club</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Shane P Connelly &lt;shane@eskibars.com&gt;</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/LendingClub.pm blib\lib\LendingClub.pm 
